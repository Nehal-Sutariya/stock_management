                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <div class="ms-auto text-center">
                                    <a class="btn btn-link text-danger text-gradient px-3 mb-0" data-bs-toggle="modal" data-bs-target="#modelDelete" href="javascript:;"><i class="far fa-trash-alt me-2"></i>Delete</a>
                                    
                                    <a class="btn btn-link text-dark px-3 mb-0 edit-button" href="{{ route('updateStock', ['id' => $stock->id]) }}">
